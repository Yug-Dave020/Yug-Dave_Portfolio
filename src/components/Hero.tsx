...
import { Mail, Bot, Container, Sparkles } from "lucide-react";
import Image from "next/image";
import { Github, Linkedin } from "@/components/icons";

export function Hero() {
  return (
    <section id="home" className="min-h-screen pt-32 pb-20 px-8 max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 relative overflow-hidden">
      ...
      <div className="flex-1 w-full relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-[1.1] text-balance">
            AI Systems Engineer
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl max-w-lg mb-10 leading-relaxed">
            AI Systems Builder & Digital Transformation Specialist. I don&apos;t just build software; I build systems that evolve.
          </p>

          <div className="flex items-center gap-4 mb-16">
            <a
              href="#projects"
              className="px-8 py-4 bg-accent hover:bg-accent/90 text-white font-bold rounded-full transition-all"
            >
              View Projects
            </a>
            <a
              href="mailto:daveyug2002@gmail.com"
              className="p-4 border border-white/10 hover:border-white/20 hover:bg-white/5 rounded-full transition-all text-zinc-300"
              aria-label="Email"
            >
      ...
      <div className="flex-1 w-full relative min-h-[600px] flex items-center justify-center">
        ...
        >
          <div className="relative w-[600px] h-[600px]">
            {/* React Icon */}
            <div className="absolute top-[5%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-2xl bg-[#1c2c3a] border border-[#2d465c] p-2 flex items-center justify-center shadow-[0_0_15px_rgba(97,218,251,0.2)]">
            ...
            {/* TypeScript Icon */}
            <div className="absolute top-[25%] right-[5%] translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-xl bg-[#3178C6]/10 border border-[#3178C6]/30 p-2.5 flex items-center justify-center shadow-[0_0_15px_rgba(49,120,198,0.2)]">
              <motion.div animate={{ rotate: -360 }} transition={{ duration: 50, repeat: Infinity, ease: "linear" }} className="w-full h-full flex items-center justify-center">
            ...
            {/* Python Icon */}
            <div className="absolute bottom-[25%] right-[5%] translate-x-1/2 translate-y-1/2 w-12 h-12 rounded-xl bg-[#3776AB]/10 border border-[#3776AB]/30 p-2 flex items-center justify-center shadow-[0_0_15px_rgba(55,118,171,0.2)]">
              <motion.div animate={{ rotate: -360 }} transition={{ duration: 50, repeat: Infinity, ease: "linear" }} className="w-full h-full flex items-center justify-center">
            ...
            {/* AI / LLM (Sparkles) */}
            <div className="absolute bottom-[5%] left-1/2 -translate-x-1/2 translate-y-1/2 w-14 h-14 rounded-full bg-indigo-500/10 border border-indigo-500/30 p-3 flex items-center justify-center shadow-[0_0_15px_rgba(99,102,241,0.2)]">
              <motion.div animate={{ rotate: -360 }} transition={{ duration: 50, repeat: Infinity, ease: "linear" }} className="w-full h-full flex items-center justify-center">
            ...
            {/* Docker Icon */}
            <div className="absolute bottom-[25%] left-[5%] -translate-x-1/2 translate-y-1/2 w-12 h-12 rounded-xl bg-[#2496ED]/10 border border-[#2496ED]/30 p-2 flex items-center justify-center shadow-[0_0_15px_rgba(36,150,237,0.2)]">
              <motion.div animate={{ rotate: -360 }} transition={{ duration: 50, repeat: Infinity, ease: "linear" }} className="w-full h-full flex items-center justify-center">
            ...
            {/* Tailwind CSS Icon */}
            <div className="absolute top-[25%] left-[5%] -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-xl bg-[#06B6D4]/10 border border-[#06B6D4]/30 p-2.5 flex items-center justify-center shadow-lg">
              <motion.div animate={{ rotate: -360 }} transition={{ duration: 50, repeat: Infinity, ease: "linear" }} className="w-full h-full flex items-center justify-center">
        ...
        <motion.div
          ...
          className="relative z-10 w-[350px] h-[450px]"
        >
          {/* Glass Container */}
